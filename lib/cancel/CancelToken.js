...
class CancelToken {
  constructor(executor) {
    ...
    /*
      ...
      这里之所以要额外使用Promise链，而不是直接将执行listeners的方法抛出，TODO:主要是因为promise？，也更方便了(this指向)。
    */
    ...
    /*
      这一段代码实际是对 config.cancelToken 的版本向下兼容。防止用户的代码设置的config.cancelToken是布尔值。
      因为cancelToken的第一次在xhr.js的版本是(`commit` - 96956e3)：
